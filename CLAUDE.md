...
- **v=20260704a~d** (브랜치 `preview/nexora-restyle` `50605e4`, **🔴 main 미머지 — 프리뷰 검증 중**) — Nexora 레퍼런스 기반 대규모 리디자인 2건 + 전략실장 피드백 4라운드 반영. 최신 프리뷰 배포 URL은 `vercel ls`(SSO 보호). 상세 → auto-memory `pending-aibranch-nexora-restyle-2026-07-04.md`.
  ...
  - 🔴 **잔여**: 실사진 아바타 파일 저장 대기(`assets/images/consultant-avatar.jpg`, 전략실장 제공 예정 — 저장 즉시 자동 적용) / 구 roadmap-* CSS·JS 데드코드 정리(가드로 무해, 머지 시 정리 후보) / 전략실장 최종 OK 후 main 머지.
